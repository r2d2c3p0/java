...
public class AsymmetricCryptography {
	...
	public PrivateKey getPrivate(String filename) throws Exception {
		...
		byte[] keyBytes = Files.readAllBytes(FileSystems.getDefault().getPath(new File(filename).getPath()));
	...
	public static void main(String[] args) throws Exception {
		...
		PrivateKey privateKey = ac.getPrivate("common/private.key");
		PublicKey publicKey = ac.getPublic("common/public.key");

		/*
		 * String message = "Dallas Cowboys - SuperBowl L2"; String
		 * encrypted_msg = ac.encryptText(message, privateKey); String
		...
		if (args[0].equals("enc")) {
			...
			try {
				...
				fr = new FileReader("common/0.txt");
				br = new BufferedReader(fr);

				fw = new FileWriter("common/1.txt");
				bw = new BufferedWriter(fw);

				String sCurrentLine;

				br = new BufferedReader(new FileReader("common/0.txt"));
		...
		if (args[0].equals("dec")) {
			...
			try {
				...
				fr0 = new FileReader("common/1.txt");
				br0 = new BufferedReader(fr0);

				String sCurrentLine;

				br0 = new BufferedReader(new FileReader("common/1.txt"));
